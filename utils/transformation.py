...
def quat_angle(q1, q2):
    ...
    Parameters:
    - q1: array-like, quaternion [w, x, y, z]
    - q2: array-like, quaternion [w, x, y, z]

    Returns:
    - angle: float, the angle between the two quaternions in radians
    """
    # Normalize the quaternions (in case they're not normalized)
